...
(function(){
	...
	for (var i = 0; i < flairs.length; i++) {
		if (flairs[i].textContent === "")
			continue;
		var r;
		if (flairs[i].className.indexOf("americas") !== -1)
			r = "us";
		else if (flairs[i].className.indexOf("europe") !== -1)
			r = "eu";
		else if (flairs[i].className.indexOf("asia") !== -1)
			r = "as";
		else
			continue;
